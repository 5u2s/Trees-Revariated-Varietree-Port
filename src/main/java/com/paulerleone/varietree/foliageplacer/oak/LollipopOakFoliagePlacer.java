...
public class LollipopOakFoliagePlacer extends FoliagePlacer {
    public static final Codec<LollipopOakFoliagePlacer> CODEC = RecordCodecBuilder.create(LollipopOakFoliagePlacerInstance
            -> foliagePlacerParts(LollipopOakFoliagePlacerInstance).and(Codec.intRange(0, 16).fieldOf("height")
            .forGetter(fp -> fp.height)).apply(LollipopOakFoliagePlacerInstance, LollipopOakFoliagePlacer::new));
    private final int height;

    public LollipopOakFoliagePlacer(IntProvider pRadius, IntProvider pOffset, int height) {
    ...
    protected FoliagePlacerType<?> type() {
        return ModFoliagePlacers.LOLLIPOP_OAK_FOLIAGE_PLACER.get();
    }
