...
public class CandleSpruceFoliagePlacer extends FoliagePlacer {
    public static final Codec<CandleSpruceFoliagePlacer> CODEC = RecordCodecBuilder.create(CandleSpruceFoliagePlacerInstance
            -> foliagePlacerParts(CandleSpruceFoliagePlacerInstance).and(Codec.intRange(0, 16).fieldOf("height")
            .forGetter(fp -> fp.height)).apply(CandleSpruceFoliagePlacerInstance, CandleSpruceFoliagePlacer::new));
    private final int height;

    public CandleSpruceFoliagePlacer(IntProvider pRadius, IntProvider pOffset, int height) {
    ...
    protected FoliagePlacerType<?> type() {
        return ModFoliagePlacers.CANDLE_SPRUCE_FOLIAGE_PLACER.get();
    }
